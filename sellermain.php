...
<a href="carsupload.php" target="_self"><img id="upload" src="img/upload.png"></a>
</body>
</html>
<?php
session_start();
...
{
$query="select username from sellers where mailid='$mail'";
...
echo "</form>";
$query="select profilepic from sellers where mailid='$mail'";
$res=mysqli_query($conn,$query);
$row=mysqli_fetch_array($res);
$path="images/".$mail."/".$row['profilepic'];
//.................................................................................................................................
echo "<img src=$path id='profile' onclick='index.php' alt='no image found'><br>";
//.................................................................................................................................
//showing users vehicals
$query="select * from cars where path1='$mail'";
...
if(mysqli_num_rows($x)>0)
	...
	while($result=mysqli_fetch_array($x))
		...
		echo "<td id='col3'><button id='delete'>Delete</button>
