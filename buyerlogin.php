...
if(mysqli_num_rows($res))
	{
	$temp=1;
	$query="select password from buyers where mailid='$mail' and password='$passwd'";
	$res=mysqli_query($conn,$query);
	if(mysqli_num_rows($res))
		{
...
<body>
<a href="buyersignup.html" target="_self" id="signbutton">Signup</a>
<table>
