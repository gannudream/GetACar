...
if($result)
	...
	{
	//creating folder for seller
	mkdir("images/$mail");
	//img upload
	$target="images/$mail/".basename($_FILES['profilepicture']['name']);
	$image=$_FILES['profilepicture']['name'];
	$query="insert into sellers(mailid,username,password,repassword,mobilenum,profilepic,nitems) values('$mail','$uname','$pword','$cpassword','$tel','$image',0)";
